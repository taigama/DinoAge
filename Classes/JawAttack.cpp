...
bool JawAttack::init()
{
	...
	_projectileType = PROJECTILE_TYPE::JAW_ATTACK;
...
void JawAttack::update(float delta)
{
	if (_timer <= 0)
	{
...
void JawAttack::reset(float params[10])
{
	this->setActive(true);
	_timer = ATTACK_TIME;
...
void JawAttack::attack(Character* target, Character::DIRECTION dir)
{
	// make enemy hurted
